...
<div id="stream">
		...
		<form id="register"  action ="add_products.php" method ="POST" enctype="multipart/form-data">
			...
			<?php if(isset($errors['author']))
				{
				echo '<span class="err">'.$errors['author']. '</span>' ;
				} ?>
				<label>Author</label>	
			...
			<?php if(isset($errors['cat']))
				{	
				echo '<span class="err">'.$errors['cat']. '</span>' ; 
				} ?>
			...
			{	echo '<span class="err">'.$errors['price']. '</span>' ; 
			} ?>
				<label>Price:</label>
			...
			{	echo '<span class="err">'.$errors['year']. '</span>' ; 
			} ?>
				<label>Year:</label>	
				<input type="text" name="year" placeholder="2017/04/04">
			</div>

			<div>
			<?php if(isset($errors['isbn']))
			{	echo '<span class="err">'.$errors['isbn']. '</span>' ; 
			} ?>
				<label>ISBN:</label>	
			...
			{	echo '<span class="err">'.$errors['pic']. '</span>' ; 
			} ?>
